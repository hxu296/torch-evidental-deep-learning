...
class TemporalModelBase(nn.Module):
    ...
    def __init__(self, num_joints_in, in_features, num_joints_out,
        ...
        self.shrink_bn = nn.BatchNorm1d(num_joints_out*3, momentum=0.1)
        self.uncertainty = edl.layers.dense.DenseNormalGamma(num_joints_out*3, num_joints_out*3)
...
class TemporalModel(TemporalModelBase):
    ...
    def _forward_blocks(self, x, sz):
        ...
        x = self.shrink_bn(self.shrink(x))
        x = x.permute(0, 2, 1)
